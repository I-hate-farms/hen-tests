...
valac  -g -X -rdynamic -X -w --pkg linux --pkg gee-0.8 --target-glib=2.32  -o ./samples/sample_colors ./samples/error_colors.vala ./src/Stacktrace.vala
./samples/sample_colors

# Build library
# valac  -g  -X -w --pkg linux --pkg gee-0.8 --target-glib=2.32  --vapi=../test.vapi -o ./samples/stacktrace ./src/Stacktrace.vala

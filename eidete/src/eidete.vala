...
namespace Eidete {
    ...
    public class EideteApp : Granite.Application {
        construct {
            program_name = "Eidete";
            exec_name =  Build.BINARY_NAME;

            build_data_dir = Build.DATA_DIR;
            build_pkg_data_dir = Build.PACKAGE_DATA_DIR;
            build_release_name = Build.RELEASE_NAME;
            build_version = Build.VERSION;
            build_version_info = Build.VERSION;

            app_years = "2011-2015";
            app_icon = Build.ICON_FILE;
        ...
        public void start_and_build () {
            ...
            */
            ...
            var width = new Gtk.SpinButton.with_range (50, Gdk.Screen.get_default ().get_width (), 1);
            width.max_length = 4;
            width.margin_left = 1;

            var height = new Gtk.SpinButton.with_range (50, Gdk.Screen.get_default ().get_height (), 1);
            height.max_length = 4;
            ...
            var buttons = new Gtk.Box (Gtk.Orientation.HORIZONTAL, 5);
            buttons.homogeneous = true;
            buttons.pack_start (about_bt, false, true, 0);
            buttons.pack_start (cancel_bt, false, true, 0);
            buttons.pack_end (start_bt, false, true, 0);
            ...
            */
            ...
            monitors_combo.changed.connect (() => {
                ...
                settings.sx = this.monitor_rec.x;

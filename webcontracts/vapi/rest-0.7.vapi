...
namespace Rest {
	...
	[CCode (ref_function = "rest_param_ref", unref_function = "rest_param_unref", cheader_filename = "rest/rest-param.h")]
	[Compact]
	public class Param {
		...
		public void unref ();
		[CCode (cname="rest_param_new_full")]
        public Param.new_full ([CCode (type = "const char*")] string name,
                                      Rest.MemoryUse use,
                                      [CCode (type = "gconstpointer", array_length_type = "gsize")] uint8 [] data,
                                      [CCode (type = "const char*")] string content_type,
                                      [CCode (type = "const char*")] string filename);
	}
